...
const mappedTempratures = temperatures.map((f) => {
    return (f - 32) * (5/9)
 
})
return mappedTempratures;
};
...
const filteredTempratures = temperatures.filter(e =>     e>threshhold)
    return filteredTempratures;
//return filteredTempratures;
};
...
//const filteredTempratures = temperatures.filter((e) => )
